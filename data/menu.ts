export const menu = [
  {
    title: "Entrées",
    note: "Assiettes d'ouverture, fritures legeres et preparations servies a partager.",
    items: [
  ...
  {
    title: "Ramen",
    note: "Bouillons cuits longuement, nouilles fermes et garnitures preparees chaque jour.",
    items: [
      ["Tonkotsu Yashiki", "Bouillon long, poitrine confite, oeuf mariné", "23"],
  ...
  {
    title: "Sushi & Sashimi",
    note: "Poissons selon arrivage, riz tiede et coupe minute au moment du service.",
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      ["Boeuf au binchotan", "Cuisson vive, légumes braisés, tare", "31"],
      ["Tofu grillé", "Bouillon dashi clair, poireau brûlé, sésame", "22"],
    ],
  },
  {
    title: "Desserts",
    note: "Desserts legers, textures souples et finales nettes en fin de repas.",
    items: [
      ["Mochi glacé", "Sésame noir ou matcha", "9"],
      ["Flan hojicha", "Crème soyeuse, caramel thé grillé", "11"],
  ...
  {
    title: "Boissons",
    note: "Sake, cocktails, thés et verres choisis pour accompagner la cuisine sans lourdeur.",
    items: [
