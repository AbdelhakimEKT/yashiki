...
export default function MenuPreviewLink() {
  return (
    ...
    >
      ...
      <span className="flex h-7 w-7 items-center justify-center rounded-full bg-[var(--sage)] text-[10px] text-[var(--cream-soft)] transition duration-300 group-hover:bg-[var(--sage-deep)]">
        +
      </span>
    </Link>
  );
